...
const Client_1 = require("./Client"); // Importa a entidade Client
...
__decorate([
    ...
    (0, typeorm_1.JoinColumn)({ name: "client_id" }) // Opcional: especifica o nome da coluna FK no BD
    ,
...
exports.Order = Order = __decorate([
    (0, typeorm_1.Entity)("orders") // Nome da tabela em inglês
], Order);
