...
const OrderItem_1 = require("../database/entities/OrderItem"); // Precisa do OrderItem também
const StockMovement_1 = require("../database/entities/StockMovement"); // Precisa do StockMovement
const Product_1 = require("../database/entities/Product"); // Precisa do Product para verificar estoque
const Client_1 = require("../database/entities/Client"); // Precisa do Client
const database_1 = require("../database");
const typeorm_1 = require("typeorm"); // Para transações e consultas IN
// DTOs
const CreateOrderDTO_1 = require("../dtos/orders/CreateOrderDTO"); // DTO para criação de pedido
const CreateOrderItemDTO_1 = require("../dtos/orders/CreateOrderItemDTO"); // DTO para item de pedido dentro do CreateOrderDTO
const UpdateOrderDTO_1 = require("../dtos/orders/UpdateOrderDTO"); // DTO para atualização de pedido
...
class OrderService {
    ...
    async create(orderData) {
        ...
        const orderInstance = (0, class_transformer_1.plainToInstance)(CreateOrderDTO_1.CreateOrderDTO, orderData);
        const errors = await (0, class_validator_1.validate)(orderInstance);
        if (errors.length > 0) {
        ...
        try {
            ...
            const client = await queryRunner.manager.findOneBy(Client_1.Client, { id: orderInstance.clientId });
            if (!client) {
            ...
            const products = await queryRunner.manager.findBy(Product_1.Product, { id: (0, typeorm_1.In)(productIds) });
            ...
            for (const item of orderInstance.items) {
                ...
                const orderItemInstance = (0, class_transformer_1.plainToInstance)(CreateOrderItemDTO_1.CreateOrderItemDTO, item);
                const itemErrors = await (0, class_validator_1.validate)(orderItemInstance);
    ...
    async updateStatus(id, updateData) {
        ...
        const updateInstance = (0, class_transformer_1.plainToInstance)(UpdateOrderDTO_1.UpdateOrderDTO, updateData);
